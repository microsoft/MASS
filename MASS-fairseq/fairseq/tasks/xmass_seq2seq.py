...
from fairseq.data import (
    ...
    MonolingualDataset,
    TokenBlockDataset,
    FastMonolingualDataset,
    MaskedLanguagePairDataset,
    MaskedBilingualDataset,
    MaskedBilingualDatasetV2,
...
from . import register_task, FairseqTask
from .semisupervised_translation import parse_lambda_config
...
class XMassTranslationTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--word_mask', default=0.25, type=float, metavar='RATIO',
                            help='The mask ratio')
        parser.add_argument('--lang_tok', default='False', type=str, metavar='BOOL',
                            help='Using language token')
